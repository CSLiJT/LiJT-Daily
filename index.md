  ...
  <div class="main">
    <div class="content">
      <div class="author-avatar">
        <img itemprop="image" alt="my photo" src="./images/title.jpg" />
      </div>
      <h1 itemprop="name" class="title-text">{{ site.author.name }}</h1>
      {% include author-links.html author=site.author %}
      <p><a itemprop="url" class="social-link blog" title="欢迎进入我的灵质空间." href="/navigate-page/blog" target="_self">Visit My Blog</a></p>
    </div>
  </div>
</div>
